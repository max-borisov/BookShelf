...
What You Need:Ruby 2.1, Rails 4",
  ...
  },
  {
      ...
      pub_date: '25/09/2014',
      description: "Fast-track your web application development using the new generation Yii PHP framework
...
You will learn how to use Yii's active record and CRUD scaffolding to manage the data in your database. Authentication, extensions, events and behaviors, and route management are just some of the many other features of Yii that you will learn from this book. By the end of this book, you will have a basic CRM application that is all set for service!",
  ...
  },
  {
      ...
      pub_date: '25/02/2010',
      description: "Everyone in the Ruby world seems to be talking about metaprogramming--how you can use it to remove duplication in your code and write elegant, beautiful programs. Now you can get in on the action as well.
...
Updated to include Ruby 1.9 and 2.0, the second edition includes recipes for the Rails framework and other projects involving Ruby. From data structures and algorithms to integration with cutting-edge technologies, Ruby Cookbook covers a wide range of programming topics for beginners and advanced Rubyists alike.",
  ...
  },
  {
      ...
      author: 'Peter Cooper',
      pub_date: '19/07/2009',
      description: "Based on the bestselling first edition, Beginning Ruby: From Novice to Professional, Second Edition is the leading guide for every type of reader who wants to learn Ruby from the ground up.
...
Beginning programmers, programmers new to Ruby, and web developers interested in knowing the foundations of the language.",
  ...
  },
  {
      ...
      pub_date: '31/03/2015',
      description: "Ruby on Rails is an open source web framework. It's famously simple to build a basic Rails application. Once you've started down the track, however, you discover that Rails is a powerful, deep, and rich full-stack platform capable of tackling virtually any development challenge.
